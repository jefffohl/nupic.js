...
var Parameters = function() {
  ...
  for (var key1 in this.DEFAULTS_TEMPORAL) {
    this.DEFAULTS_ALL[key1] = this.DEFAULTS_TEMPORAL[key1];
  }

  for (var key2 in this.DEFAULTS_SPATIAL) {
    this.DEFAULTS_ALL[key2] = this.DEFAULTS_SPATIAL[key2];
  }
};
